...
#define MAX_SPOTS         30        // NOTE: It must be the same as define in shader
...
// Делает копию и возвращает постоянный указатель на копию.
// Можно менять значения возвращенной структуры

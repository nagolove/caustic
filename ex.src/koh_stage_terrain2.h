...
bool get_cell_under_local_point( Stage_Fight *st, Vector2 local_pos, int *i, int *j);
bool get_cell_under_world_point( Stage_Fight *st, Vector2 world_pos, int *i, int *j);
